  ...
  <div class="min-h-screen bg-[#faf9f7] py-8 px-4">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="px-4 sm:px-8 pb-6 relative">
          ...
          <div class="grid grid-cols-2 gap-4 mt-6 sm:flex sm:gap-8 sm:ml-32">
            ...
            <div class="text-center sm:text-left">
              ...
              <p class="text-white font-semibold">{{ user.membership }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        ...
        >
          <div
            class="bg-white rounded-xl shadow-sm border border-secondary p-6 hover:shadow-md hover:border-[#1a3a35]/30 transition-all group cursor-pointer"
          >
        ...
        <div class="p-8">
          ...
          >
            ...
            <div class="flex justify-end gap-3 pt-4">
              ...
              <button
                class="px-6 py-3 bg-[#1a3a35] text-white rounded-lg font-medium hover:bg-[#2a4a45] transition-colors"
              >
                Save Changes
              </button>
            </div>
...
<script setup>
  ...
  const user = ref({
    ...
    lastBooking: "4 Mar, 2025",
    totalBookings: "12",
    membership: "Weekly Cricket + Gym",
  ...
  const paymentHistory = ref([
    {
      id: 1,
      description: "Weekly Subscription - Cricket Only",
      date: "March 24, 2026",
      method: "Stripe",
      amount: "$85.00",
      status: "Completed",
    ...
    {
      id: 2,
      description: "Lane Booking - Lane 3",
      date: "March 20, 2026",
      method: "PayPal",
      amount: "$40.00",
      status: "Completed",
    ...
    {
      id: 3,
      description: "Weekly Subscription - Cricket + Gym",
      date: "March 17, 2026",
      method: "Stripe",
      amount: "$100.00",
      status: "Completed",
