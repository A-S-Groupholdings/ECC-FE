  ...
  <div class="min-h-screen bg-[#faf9f7] flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Member Verification</h1>
...
<script setup>
  ...
  import { UserLogin, UserSendOtp } from "@/services/apiService.js";
  ...
  async function verifyOtp() {
    ...
    try {
      const response = await UserLogin(email.value, otp);
  ...
  onMounted(() => {
    ...
    // Redirect to member register if no email
    if (!email.value) {
